  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        const staticUrls = [
          "/", "/en", "/market", "/marketplace", "/news", "/blog", "/community", "/membership",
          "/support", "/faq", "/referrals", "/disputes", "/auth", "/about",
          "/how-it-works", "/for-investors", "/for-founders", "/pricing",
          "/projects/new", "/sitemap",
        ];
        const dyn: string[] = [];
        try {
